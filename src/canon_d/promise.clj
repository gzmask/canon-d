...
(defn intro1 [b]
  ...
  (at (m (+ 1 (rand 0.1) b)) (p/sampled-piano (o/note :d2) :level 0.5))
  (at (m (+ 2 (rand 0.1) b)) (p/sampled-piano (o/note :f3) :level 0.5))
  (at (m (+ 3 (rand 0.1) b)) (p/sampled-piano (o/note :a2) :level 0.5)))
(intro1 (m))
(defn intro2 [b]
  (at (m (+ 0 b)) (p/sampled-piano (o/note :a2) :level 0.5))
  (at (m (+ 1 (rand 0.1) b)) (p/sampled-piano (o/note :d2) :level 0.5))
  (at (m (+ 2 (rand 0.1) b)) (p/sampled-piano (o/note :f3) :level 0.5))
  (at (m (+ 3 (rand 0.1) b)) (p/sampled-piano (o/note :bb2) :level 0.5)))
(intro2 (m))
(defn intro3 [b]
  (at (m (+ 0 b)) (p/sampled-piano (o/note :d2) :level 0.5))
  (at (m (+ 1 (rand 0.1) b)) (p/sampled-piano (o/note :a3) :level 0.5))
  (at (m (+ 2 (rand 0.1) b)) (p/sampled-piano (o/note :f3) :level 0.5))
  (at (m (+ 3 (rand 0.1) b)) (p/sampled-piano (o/note :bb3) :level 0.5)))
(intro3 (m))
(defn intro4 [b]
  (at (m (+ 0 b)) (p/sampled-piano (o/note :g3) :level 0.5))
  (at (m (+ 1 (rand 0.1) b)) (p/sampled-piano (o/note :a#3) :level 0.5))
  (at (m (+ 2 (rand 0.1) b)) (p/sampled-piano (o/note :f4) :level 0.5))
  (at (m (+ 3 (rand 0.1) b)) (p/sampled-piano (o/note :a#3) :level 0.5)))
(intro4 (m))
...
(def piano1 (mk-intro-player {:loop? true :song-func intro :beat-length 24}))
(piano1 :play)
(piano1 :play intro1 8)
(piano1 :play intro2 8)
(piano1 :play intro3 8)
(piano1 :play intro4 8)
(piano1 :play intro 24)
(piano1 :loop?)
(piano1 :stop)
(def p2 (mk-intro-player {:loop? true :song-func intro :beat-length 24}))
(p2 :play)
(p2 :play intro1 8)
(p2 :play intro2 8)
(p2 :play intro3 8)
